...
(define ED1 (make-editor ""    "")) ; blank text box 
(define ED2 (make-editor "abc" "d")) ; abcd with cursor between c and d
(define ED3 (make-editor "abcd"  "")) ; abcd with cursor after d  
(define ED4 (make-editor ""    "abcd")) ; abcd with cursor before a
...
(check-expect (cursor-right (make-editor "cow" "cat"))
              (make-editor "cowc" "at"))
...
(check-expect (backspace (make-editor "a"   "")) (make-editor ""   ""))
(check-expect (backspace (make-editor ""   "a")) (make-editor ""  "a"))
(check-expect (backspace (make-editor "abc" "")) (make-editor "ab" ""))
(check-expect (backspace (make-editor "ab" "c")) (make-editor "a" "c"))
(check-expect (backspace (make-editor "a" "bc")) (make-editor "" "bc"))
...
(check-expect (insert (make-editor "" "") "") (make-editor "" ""))
(check-expect (insert (make-editor "" "bcd") "a") (make-editor "a" "bcd"))
(check-expect (insert (make-editor "abc" "") "d") (make-editor "abcd" ""))
(check-expect (insert (make-editor "ab" "de") "c") (make-editor "abc" "de"))
...
(define (insert e s)
   (make-editor (string-append (editor-pre e) s) (editor-post e)))

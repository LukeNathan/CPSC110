...
(define (fn-for-altitude alt)
  (cond [(and (string? alt) (string=? alt "pre-launch")) (...)]
        ;[(and (number? alt) (<= alt 0)) (... alt)]
        [(number? alt) (... alt)]
        [(string=? alt "post-flight") (...)]))
...
(define (inflight? alt)
  (cond [(and (string? alt) (string=? alt "pre-launch")) false]
        [(number? alt) true]
        [(string=? alt "post-flight") false]))

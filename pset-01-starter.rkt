...
;(define (taller-image img1 img2) img1)

(check-expect (taller-image (rectangle 20 40 "solid" "blue")
                            (rectangle 20 30 "solid" "blue"))
              (rectangle 20 40 "solid" "blue"))

(check-expect (taller-image (rectangle 20 30 "solid" "red")
                            (rectangle 20 45 "solid" "red"))
              (rectangle 20 45 "solid" "red"))

(check-expect (taller-image (rectangle 20 40 "solid" "green")
                            (rectangle 20 40 "solid" "green"))
              (rectangle 20 40 "solid" "green"))

(@template-origin Image)

(@template
 (define (taller-image img1 img2)
   (... img1 img2)))

(define (taller-image img1 img2)
  (if (> (image-height img1) (image-height img2))
      img1
      img2))

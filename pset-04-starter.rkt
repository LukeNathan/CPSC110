...
(define B2 (make-ball (/ WIDTH 3) (/ HEIGHT 3) -4 3))
...
(check-expect (render-ball (cons (make-ball 300 200 10 5) empty))
                           (place-image BALL 300 200 MTS))

(check-expect (render-ball (cons (make-ball 250 150 15 7)
                            (cons (make-ball 100 50 3 4) empty)))
                           (place-image BALL 250 150
                            (place-image BALL 100 50 MTS)))
...
(check-expect (next-balls (cons (make-ball 100 150 10 15) empty))
                          (cons (make-ball 110 165 10 15) empty))

(check-expect (next-balls (cons (make-ball 50 75 5 7)
                                (cons (make-ball 150 200 15 20) empty)))
              (cons (make-ball 55 82 5 7)
                    (cons (make-ball 165 220 15 20) empty)))
...
;; PLACE BALL
(@htdf place-ball)
(@signature ListOfBall Image -> Image)

(check-expect (place-ball (make-ball 200 300 5 10) MTS)
              (place-image BALL 200 300 MTS))

(check-expect (place-ball (make-ball 123 321 -10 5)
                          (square 400 "solid" "blue"))
              (place-image BALL 123 321
                          (square 400 "solid" "blue")))
...
(check-random (handle-mouse empty 250 250 "button-down")
              (cons (make-ball 250 250
                               (- 5 (random 11)) (- 5 (random 11))) empty))
              
(check-random (handle-mouse (cons (make-ball 1 2 3 4) empty)
                            100 200 "button-down")
              (cons (make-ball 100 200
...
(check-expect (handle-key (cons B1 (cons B1 empty)) " ") empty)
(check-expect (handle-key (cons B1 empty) "a") (cons B1 empty))

;(define (handle-key (cons B1 empty) "a") MTS)
